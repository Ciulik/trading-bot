...
def save_prices_to_file(prices, filename="prices.json"):
...
if __name__ == "__main__":
    ...
    df = fetch_historical_data('BTCUSDT', days=1, interval='1m')
    ...
    predictor = PricePredictor(lookback_period=12)
    ...
    print("\n[STEP 3] Starting live validation...")
    result = live_prediction_validation(predictor, prices, interval='1m', wait_minutes=1)
